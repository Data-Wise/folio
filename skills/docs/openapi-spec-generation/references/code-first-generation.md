...
Templates for generating OpenAPI specs from code annotations.

## Table of Contents

- [Python / FastAPI](#python--fastapi)
- [TypeScript / Express with tsoa](#typescript--express-with-tsoa)

## Python / FastAPI

FastAPI generates an OpenAPI spec automatically from Pydantic models and endpoint decorators.
...
tsoa generates OpenAPI from TypeScript decorators on controller classes.
